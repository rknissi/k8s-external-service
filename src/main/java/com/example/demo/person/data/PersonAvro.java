...
public class PersonAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public PersonAvro(java.lang.Long id, java.lang.CharSequence name, java.lang.Long age) {
    this.id = id;
    this.name = name;
    this.age = age;
  }
   ...
   */
  public static com.example.demo.person.data.PersonAvro.Builder newBuilder() {
    return new com.example.demo.person.data.PersonAvro.Builder();
  }
   ...
   * @return A new PersonAvro RecordBuilder
   */
  public static com.example.demo.person.data.PersonAvro.Builder newBuilder(com.example.demo.person.data.PersonAvro.Builder other) {
    return new com.example.demo.person.data.PersonAvro.Builder(other);
  }
   ...
   * @return A new PersonAvro RecordBuilder
   */
  public static com.example.demo.person.data.PersonAvro.Builder newBuilder(com.example.demo.person.data.PersonAvro other) {
    return new com.example.demo.person.data.PersonAvro.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PersonAvro>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.demo.person.data.PersonAvro.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.demo.person.data.PersonAvro other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.person.data.PersonAvro.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.person.data.PersonAvro.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.person.data.PersonAvro.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.person.data.PersonAvro.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.person.data.PersonAvro.Builder setAge(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.person.data.PersonAvro.Builder clearAge() {
